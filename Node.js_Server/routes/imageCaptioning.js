...
/*
* @return
*     sentence: Caption text generated by model
*
*/
router.post('/predictCaption', async function (req, res) {
    ...
    let result = null;
    let statusCode = 200
    //result={"sentence":"This is a sample caption that server returned for testing"};
    ...
    python.on('close', (code) => {
        ...
        fs.unlink(filePath, (err) => {
            if (err) {
            console.error(err)
            return res.status(500).json({"result":"Error deleting file"});
            }
        });
